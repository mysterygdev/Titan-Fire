  ...
  <div class="container-fluid">
    ...
    <main>
      <section class="container">
        <!-- Downloads -->
        <div class="container">
          <p>Thank you for choosing to download <strong>{{APP['title']}}</strong> Please note that by downloading our server you agree to our <a href="/server/terms" class="terms">Terms of Service</a>.</p>
            ...
            <table class="table-dark table-striped table-bordered table-sm container">
              <thead>
                <tr>
                  ...
                  <br>
                  @include('partials.cms.separator')
                  <br>

    ...
    <div class="collapse navbar-collapse" id="main-nav">
      ...
      <ul class="nav navbar-nav navbar-right">
        @guest
          ...
          {{display('logout_form_modal','<i class="fas fa-sign-in-alt"></i>','0','2','Logout Form')}}
        ...
        @else
          <li class="dropdown">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">{{$data['user']->DisplayName}} <span class="caret"></span></a>
            <ul class="dropdown-menu">
              @adm
